export const products = [
    ...
    { 
        ...
        quantity: 1,
        description: 'Before plugging in check the voltage on the rating label corresponds to the local mains voltage. As a general guide, use the high heat and speed setting for rough drying for thicker hair, and the low setting for finer hair and more precise control when styling. The cool setting can be used at the end to set the style. Wash and condition the hair, then gently towel dry hair to remove excess water.',
        discount: 'From ₹499', 
    ...
    { 
        ...
        quantity: 1,
        description: 'You can complete all your computing requirements or have an entertaining gaming session with the Samsung 68.58 cm (27) LF27T350FHW Flat Monitor. Featuring a three-sided borderless display, this monitor boasts a minimalist design for optimal concentration. Additionally, it gives your workstation a modern appearance. Besides, as this monitor ensures that multiple screens properly align, having numerous monitors allows for distraction-free work.',
        discount: 'Minimum 40% Off', 
        tagline: 'Grab Now!' 
    }
];